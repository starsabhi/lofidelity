...
Revision ID: 467fb46fd859
Revises: 
Create Date: 2022-06-01 18:56:09.493975
...
def upgrade():
    ...
    sa.Column('bgImageUrl', sa.String(length=1000), nullable=True),
    sa.Column('coverImageUrl', sa.String(length=1000), nullable=True),
