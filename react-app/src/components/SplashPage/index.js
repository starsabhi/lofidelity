...
const SplashPage = () => {
    ...
    const [artistBackgroundImg, setArtistBackgroundImg] = useState(
        'https://lofidelity-bucket.s3.amazonaws.com/triangles-1430105.png'
    );
        ...
        <>
            ...
            >
                <div className='splash-hooks'>
                    ...
                    <p>
                        Whether listening to relax, focus on work, or anywhere
                        in between...
                    </p>
            ...
            <Link to='/login'>Already have an account? Log in</Link>
                ...
                <div className='artist-credentials'>
                    ...
                    {artistLocation && <p>from {artistLocation}</p>}
                </div>
            </div>
        </>
    );
